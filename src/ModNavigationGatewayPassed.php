...
class ModNavigationGatewayPassed extends ModuleNavigation
{
    ...
    {
        $this->session = System::getContainer()->get('countrygate.session_gate');
    ...
    protected function compile()
    {
        ...
        dump($this->preRenderNavigation($trail[$level], 1, $host, $lang)); exit;

        $this->Template->items = $this->preRenderNavigation($trail[$level], 1, $host, $lang);
        parent::compile(); // TODO: Change the autogenerated stub
    }

    protected function preRenderNavigation($pid, $level=1, $host=null, $language=null)
    {
